...
public class MainPage extends JPanel implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 420531605987543931L;
	private JLabel l1;
...
//		});
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("AI")) {
			...
			gameBoard.game.setUpAI(ai);
			System.out.println(gameBoard.game.getState().toString()) ; 
			System.out.println(gameBoard.game.isCancelled()) ; 
			System.out.println(gameBoard.game.isDone())  ; 
			gameBoard.game.execute(); // this will call start a new thread 
			
				
		}
		topFrame.mainToGame();
		gameBoard.requestFocusInWindow(); // you need this for key listener to work !!!!
		// check :
		// https://stackoverflow.com/questions/5983724/jbutton-breaks-my-keylistener
	}
